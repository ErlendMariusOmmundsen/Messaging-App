...
Her er et simplifisert klasse-diagram av hvordan klassene henger sammen i core (JSON klassene er utelatt her da).
...
Message *--> "2" Account: "to/from"

Inbox *--> "*" InboxListener: "listeners"
Inbox *--> "*" Message: "messages"
Inbox *--> "1" InboxIO: "io"

Contacts "contacts (1)" -- "accounts" Account
