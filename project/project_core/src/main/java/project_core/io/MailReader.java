...
public interface MailReader {
   ...
   * @param filename
   *        - The filename of the file where the message should be appended.
   * @throws IOException
   ...
   * 
   * @param inbox
   *        - The inbox with all the messages to be uploaded.
   * @param filename
   *        - The which should be overwritten with the new messages.
   * @throws IOException
   *         - If something goes wrong with communication with the system.
   */
   ...
   * 
   * @param filename
   *        - The filename of the file to get the messages from
