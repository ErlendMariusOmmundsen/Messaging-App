...
public interface AccountDataAccess {
  ...
  /**
   * Gets the inboxMessages of the account in the system.
   * 
   * @param account
   *        - The account that we want to get the inbox messages from.
   * @return The messages of the accounts inbox in the system.
   * @throws IOException
   *         - If something goes wrong with the communication with the system.
   */
   ...
   * @param from
   *        - The account to the inbox we want to upload to.
   * @throws IOException
   *         - If something goes wrong with the communication with the system.
   */
   ...
   * 
   * @param messages
   *        - All the messages to upload.
   * @param account
   *        - The account that we want to overwrite the inbox of.
   * @throws IOException
   *         - If something goes wrong with the communication with the system.
   */
   ...
   * 
   * @param account
   *        - The account to check if is valid.
