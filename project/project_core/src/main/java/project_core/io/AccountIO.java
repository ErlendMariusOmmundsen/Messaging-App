...
public class AccountIO {
  ...
  /*
   * // Bare en enkel test man kan kjøre i eclipse public static void main(String[] args) { try {
   * AccountIO io = new AccountIO(); List<Account> data = io.loadData(AccountIO.usersFilename);
   * System.out.println(data); } catch (IOException e) { e.printStackTrace(); } }
   */
}
